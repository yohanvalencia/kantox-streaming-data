...
def setup():
    ...
    parser.add_argument("hostname", type=str, help="Provide a hostname ",
                        nargs='?', default='http://localhost:60000')
    parser.add_argument("filename", type=str, help="Provide a data filename ",
                        nargs='?', default='../data/events.json')
